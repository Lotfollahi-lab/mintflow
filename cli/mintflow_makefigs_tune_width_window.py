...
STR_INIGEN_OR_INIGEN_SYNTH = "inflow"  # in ['inflow', 'inflow_synth']
assert(
    STR_INIGEN_OR_INIGEN_SYNTH == 'inflow' #  in ['inflow', 'inflow_synth']
)
...
BASE_PATH = inflow if(STR_INIGEN_OR_INIGEN_SYNTH=='inflow') else inflow_synth
...
parser = argparse.ArgumentParser(
    description='Inigen command-line to create figures that help tuning width_window arguments in config_data_train and config_data_test.\n This sciprts takes in some paths to some config yaml files.',
