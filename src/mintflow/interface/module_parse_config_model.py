...
def verify_and_postprocess_config_model(dict_config_model, num_tissue_sections, fname_config_model=""):
    ...
    if num_tissue_sections == 1:
        print(" There is only one training tissue section --> the batch mixing coefficient config_model['coef_xbarint2notbatchID_loss'] and config_model['coef_xbarspl2notbatchID_loss'] are set to 0.")
